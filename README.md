...
- Add option for user to generate pictures with tags that were already rated
- There is problem or not - get_top_n_ratings function can use another categories order than order in saved ratings (We should check if proper tags combinations (that were rated) are deleted)
